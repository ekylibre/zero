module ApplicationHelper
  ...
  def page_header(*args, &block)
    ...
    if block_given?
      ...
      content_tag(:div, options.deep_merge(data: {role: "header", zposition: "fixed", tap_toggle: false}), &block)
    else
      content_tag(:div, options.deep_merge(data: {role: "header", zposition: "fixed", tap_toggle: false})) do
  ...
  def page_footer(options = {}, &block)
    content_tag(:div, options.deep_merge(data: {role: "footer", zposition: "fixed", tap_toggle: false}), &block)
  end
